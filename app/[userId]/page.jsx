                ...
                <div className="lg:col-span-2 space-y-12">
                    <div className="glass rounded-2xl p-10 border border-white/5">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            {artist.bio || artist.desc || "This artist hasn't added a bio yet."}
                        </p>
                    </div>
                    ...
                    {artistArtworks.length > 0 && (
                        <div className="space-y-8">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-gray-500 text-sm font-medium">{artistArtworks.length} Pieces</span>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {artistArtworks.map((art) => (
                                    <div key={art.id} className="group relative aspect-square rounded-2xl overflow-hidden glass border border-white/5">
